...
my ($lon, $lat) = PDL::Graphics::PLplot::Map::fetch(RESOLUTION => 'crude');
...
my ($lon, $lat) = PDL::Graphics::PLplot::Map::fetch(RESOLUTION => 'low',
                                                      BOX        => \@bounds,
                                                      BOUNDARIES => [1],
                                                      COASTS     => 1);

my $pl = PDL::Graphics::PLplot->new (DEV => "png", FILE => "test4.png");
$pl->xyplot($lon, $lat);
$pl->close;
ok -s "test4.png" > 0, 4;
...
my $pl = PDL::Graphics::PLplot->new (DEV => "png", FILE => "test6.png");
$pl->xyplot($lon, $lat);
$pl->close;
ok -s "test6.png" > 0, 6;
...
my $pl = PDL::Graphics::PLplot::Map->new (DEV => "png", FILE => "test8.png");
$pl->worldmap;
$pl->close;
ok -s "test8.png" > 0, 8;

my $pl = PDL::Graphics::PLplot::Map->new (DEV => "png", FILE => "test9.png");
...
# equatorial case
my $pl = PDL::Graphics::PLplot::Map->new (DEV => "png", FILE => "test10.png");
$pl->worldmap (PROJECTION => 'AZEQDIST', # Azimuthal Equidistant projection
...
my $pl = PDL::Graphics::PLplot::Map->new (DEV => "png", FILE => "test11.png");
$pl->worldmap (PROJECTION => 'AZEQDIST', # Azimuthal Equidistant projection
